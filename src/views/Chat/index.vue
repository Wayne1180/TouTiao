    ...
    <div class="chat-list">
      <div v-for="(obj, index) in list" :key="index">
        ...
        <div class="chat-item right" v-else>
          <div class="chat-pao">{{ obj.msg }}</div>
          <van-image fit="cover" round :src="imgLink" />
        </div>
      </div>
    </div>
...
export default {
  ...
  created() {
    ...
    this.socket.on("message", (obj) => {
      ...
      this.$nextTick(() => {
        let theDiv = document.querySelector(".chat-list>div:last-child");
